...
do while (sArgs <> '')
    ...
    do  /*
        ...
        if (sDefFileOut <> '') then
        do
            say 'Syntax error: Can''t specify more than two definition files!';
            exit(4);
        end
        if (sDefFileIn = '') then
...
syntax: procedure expose (sGlobals);
    ...
    say '   <deffile>   Definition file which will have an DESCRIPTION appended.'
    say 'Options:'
